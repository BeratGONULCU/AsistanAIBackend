...
{
    // bunu ExportEgitimDatasetToExcelAsync içerisinde IFormFile ile nasıl kaydedilecek yeri gösterip dinamik kaydederiz?
    ...
    public async Task ExportEgitimDatasetToExcelAsync(string FilePath,CancellationToken cancellationToken)
    {
    ...
    public async Task<string> GetExcelPath(CancellationToken cancellationToken)
    {
        ...
        var redmineFilePath = Path.Combine(@"C:\Users\berat\Desktop\datasets", "redmine_intent_dataset.xlsx");
        return filePath;
    }
}
