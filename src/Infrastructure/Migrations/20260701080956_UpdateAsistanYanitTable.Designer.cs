...
namespace GeminiAsistanBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260701080956_UpdateAsistanYanitTable")]
    partial class UpdateAsistanYanitTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GeminiAsistanBackend.Domain.Entities.AsistanYanit", b =>
                {
                    ...
                    b.HasOne("GeminiAsistanBackend.Domain.Entities.AsistanYanit", "yanitTuru")
                        .WithMany()
                        .HasForeignKey("yanitTuruid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("cihazkomutu");

                    b.Navigation("yanitTuru");
                });
